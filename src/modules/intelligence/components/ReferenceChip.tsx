...
export function ReferenceChip({ reference }: { reference: Reference }) {
  ...
  return (
    <Link
      to={href}
      className="inline-flex min-w-0 max-w-[16rem] items-center gap-1.5 rounded-pill border border-[var(--color-border)] bg-[var(--surface-raised)] px-2.5 py-1 text-xs text-[var(--color-ink)] shadow-raised transition-shadow hover:shadow-floating"
